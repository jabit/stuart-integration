...
?>
    ...
    <div class="wrap_stuartform">
        ...
        <div class="row mb-5">
            <div class="d-flex justify-content-start">
                <div id="api-key" class="col-sm-7">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><?php _e( 'Stuart API', 'stuart-integration' ) ?></h4>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><?php _e( 'Shipping fee', 'stuart-integration' ) ?></h4>
                            <p class="card-text"><?php _e("Please indicate the price of the shipping costs according to the distance (in meters).", 'stuart-integration'); ?></p>
                            <form id="stuartShippingForm" name="stuartform" action="<?php echo esc_attr( admin_url('admin-post.php') ); ?>" method="POST">
                                <input type="hidden" name="action" value="stuart_shipping_fee_save_data" />
                                <div class="form-inline mb-3">
                                    <label for="inputFirstFee" class="col-md-6"><?php _e( '< 1500 mts', 'stuart-integration' ) ?></label>
                                    <input type="number" step="0.01" id="inputFirstFee" name="input_first_fee" class="form-control col" <?php echo get_option( 'stuart_first_fee' ) != false ? "value =".get_option( 'stuart_first_fee' ) : "value=''"; ?> placeholder="<?php _e("< 1500 mts", 'stuart-integration'); ?>">
                                </div>
                                <div class="form-inline mb-3">
                                    <label for="inputSecondFee" class="col-md-6"><?php _e( '> 1500 & < 3500 mts', 'stuart-integration' ) ?></label>
                                    <input type="number" step="0.01" id="inputSecondFee" name="input_second_fee" class="form-control col" <?php echo get_option( 'stuart_second_fee' ) != false ? "value =".get_option( 'stuart_second_fee' ) : "value=''"; ?> placeholder="<?php _e("> 1500 & < 3500 mts", 'stuart-integration'); ?>">
                                </div>
                                <div class="form-inline mb-3">
                                    <label for="inputthirdFee" class="col-md-6"><?php _e( '> 3500 mts', 'stuart-integration' ) ?></label>
                                    <input type="number" step="0.01" id="inputthirdFee" name="input_third_fee" class="form-control col" placeholder="<?php _e("1 € each kilometer.", 'stuart-integration'); ?>" readonly>
                                </div>
                                <div class="input-group">
                                    <div class="input-group-append">
                            ...
                            <div class="tab-content mt-2 border p-2">
                                <div class="tab-pane active" id="shop1" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <small class="clearfix">(<?php _e( 'Just street, number, pc, city and state and in that order. Other address info below, please!', 'stuart-integration') ?>)</small>
                                    ...
                                    <div class="form-group">
                                        <label for="pickup_phone"><?php _e( 'The phone number should be in international number format (no leading zeros or + symbol should be used).', 'stuart-integration' ) ?></label>
    ...
    -->
        ...
        <h2><?php _e( 'CLICKATELL API', 'stuart-integration' ) ?></h2>
        <p class="col-4 m-0 p-0"><?php _e("SMS provider for SMS notifications", 'stuart-integration'); ?></p>
        <div class="row mb-5">
            <div class="col-sm-6">
                <div class="card card-body">
                    <h4 class="card-title"><?php _e( 'Please place here your CLICKATELL API key', 'stuart-integration' ) ?></h4>
                    <!--<h5 class="card-subtitle"> All bootstrap element classies </h5>-->
                    <form class="form-horizontal mt-4" id="stuartClickatellKeyForm" name="stuartclickatellkeyform" action="<?php echo esc_attr( admin_url('admin-post.php') ); ?>" method="POST">
                        <input type="hidden" name="action" value="stuart_save_clickatell_key" />
                        <p class="card-text"><?php _e("You can find here your ", 'stuart-integration'); ?><a href="https://www.clickatell.com/"><?php _e("CLICKATELL API key", 'stuart-integration'); ?></a></p>
                        <div class="input-group">
                            <input type="text" class="form-control large" id="stuart_clickatell_api_key" name="stuart_clickatell_api_key" <?php echo get_option( 'stuart_clickatell_key' ) != false ? "value =".get_option( 'stuart_clickatell_key' ) : "value=''"; ?> placeholder="<?php _e("CLICKATELL API key", 'stuart-integration'); ?>">
                        </div>
                        <div class="input-group ">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit" id="button-dropoff"><?php _e("Submit", 'stuart-integration'); ?></button>
